...
<table class='table table-bordered table-hover'>
    <tr><th>
        ...
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'created_at desc'])}}"><em>
            When &uarr;

        </em></a>
        @elseif ($sort=="created_at desc")
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'created_at asc'])}}"><em>
            When &darr;
        </em></a>

        @else
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'created_at desc'])}}">
        @if ($sort==null)
            <em>
        @endif
            When
    ...
    <th>
        @if ($sort=="id asc")
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'id desc'])}}"><em>
            Proof &darr;

        </em></a>
        @elseif ($sort=="id desc")
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'id asc'])}}"><em>
            Proof &uarr;
        </em></a>

        @else
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'id asc'])}}">
            Proof
        </a>
        @endif
    </th>
    ...
    <th>
        @if ($sort=="url asc")
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'url desc'])}}"><em>
            URL &darr;

        </em></a>
        @elseif ($sort=="url desc")
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'url asc'])}}"><em>
            URL &uarr;
        </em></a>

        @else
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'url asc'])}}">
            URL
        </a>
        @endif
    </th>
    <th>
        @if ($sort=="status asc")
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'status desc'])}}"><em>
            Status &darr;

        </em></a>
        @elseif ($sort=="status desc")
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'status asc'])}}"><em>
            Status &uarr;
        </em></a>

        @else
        <a href="{{route('achievement.showProofs', ['url'=>$main->url, 'sort'=>'status asc'])}}">
            Status
        </a>
        @endif
    </th></tr>
